...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<main class="svelte-mnd5uq"><header class="svelte-mnd5uq"><h1>${escape(title)}</h1></header> <section class="container svelte-mnd5uq">${slots.default ? slots.default({}) : ``}</section> <footer class="svelte-mnd5uq"><p>© ${escape((/* @__PURE__ */ new Date()).getFullYear())} Kingdom Craft. All rights reserved.</p></footer> </main>`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-CIdmdH90.js.map
